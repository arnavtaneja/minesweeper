...
## pyautogui.click(184, 390,)

#pyautogui.moveTo((112+32*x),(520+32*x))
#pyautogui.press('space')

pyautogui.click(185,400)
timer=0
while(timer<1000):
    im = ImageGrab.grab(bbox=(80, 488, 656, 1064))  # X1,Y1,X2,Y2
    ...
    for x in range (0,9):
        for y in range (0,9):
            ...
            if (opens == Matrix[x][y]-flags):
                if( x+1 <= 8 and y+1 <= 8 and Matrix[x+1][y+1]==0):
                    pyautogui.click((32*(y+1)+54),(260+32*(x+1)), button='right')
                    Matrix[x+1][y+1]=9
                    break

                if( x+1 <= 8 and Matrix[x+1][y]==0):
                    pyautogui.click((32*y+54),(260+32*(x+1)), button='right')
                    Matrix[x+1][y]=9
                    break

                if( x+1 <= 8 and y-1 >= 0 and Matrix[x+1][y-1]==0):
                    pyautogui.click((32*(y-1)+54),(260+32*(x+1)), button='right')
                    Matrix[x+1][y-1]=9
                    break

                if( y+1 <= 8 and Matrix[x][y+1]==0):
                ...
                if( x-1 >=0  and y+1 <= 8 and Matrix[x-1][y+1]==0):
                    pyautogui.click((32*(y+1)+54),(260+32*(x-1)), button='right')
                    Matrix[x-1][ y+1]=9
                    break
